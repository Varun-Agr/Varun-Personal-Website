        ...
        <section className="px-6 pt-16 pb-12 lg:pt-24 lg:pb-16 relative z-10" id="work">
          <div className="max-w-[90%] mx-auto">
            ...
            >
              ...
              Driving <span className="text-[#4ade80]">RecOps</span> and <span className="text-[#4ade80]">People Strategy</span> at AI organisations – hiring the <span className="text-[#4ade80]">top 1% talent</span> to work on the most challenging problems.              
            </h1>
          </div>
        </section>
