        ...
        <section className="px-6 pt-16 pb-12 lg:pt-24 lg:pb-16 relative z-10" id="work">
          <div className="max-w-[90%] mx-auto">
            ...
            >
              ...
              Driving <span className="text-[#4ade80]">RecOps</span> and <span className="text-[#4ade80]">People Strategy</span> at AI organisations – hiring the <span className="text-[#4ade80]">top 1%ile</span> talent to work on the most challenging problems.              
            </h1>
          </div>
        </section>
      ...
      <footer className="px-6" id="contact">
        ...
        <div className="py-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="text-sm text-[#888] lg:text-right space-y-1">
            ...
            <p className="text-[#666] mt-2 hidden md:block">28.61&deg; N, 77.21&deg; E</p>
          </div>
        </div>
